  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/products" element={withLayout(Products, true, true)()} />
        <Route path="/contact" element={withLayout(ContactUs, true, true)()} />
        ...
        <Route element={withLayout(PrivateRoute, true, true)()}>
          <Route path="/profile" element={withLayout(Profile, false, false)()} />
        </Route>
      </Routes>
    </BrowserRouter>
  )
